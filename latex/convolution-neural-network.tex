...
\begin{tikzpicture}[x=1.6cm,y=1.1cm]
  ...
  \node[right=19,above=3,align=center,myorange!60!black] at (3.1,1.8) {합성곱(convolution)\\[-0.2em]계층};
  \node[above=3,align=center,myblue!60!black] at (6.5,1.9) {완전연결(fully-connected)\\[-0.2em]은익계층};
  ...
  % LABELS
  \node[above=3,align=center,mygreen!60!black] at (N1-1.90) {입력\\[-0.2em]계층};
  \node[above=3,align=center,myred!60!black] at (N\Nnodlen-1.90) {출력\\[-0.2em]계층};
